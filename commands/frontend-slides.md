---
description: Create animation-rich HTML presentations from scratch or by converting PowerPoint files. Visual style discovery — shows previews instead of asking abstract design questions.
---

# Frontend Slides

> **Style presets reference**: When entering Phase 2 (Style Discovery), read `~/.claude/reference/frontend-slides/STYLE_PRESETS.md` for the full 12 preset definitions including colors, fonts, and CSS variables.
